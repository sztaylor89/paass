...
config="136_08_final.xml"    #config filename
...
#for i in `ls -tr $data/a136sb_08.ldf`   #uncomment to run 1 file 
for i in `ls -tr $data/a136sb_08*.ldf`   #uncomment to run all files with similar name 
