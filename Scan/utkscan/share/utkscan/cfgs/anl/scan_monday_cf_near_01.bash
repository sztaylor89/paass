...
config="Config_monday_cf_near_01.xml"    #config filename
...
#for i in `ls -tr $data/monday_cf_near_01.ldf`   #uncomment to run 1 file 
for i in `ls -tr $data/monday_cf_near_01*.ldf`   #uncomment to run all files with similar name 
