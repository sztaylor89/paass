...
config="135_04_final.xml"    #config filename
...
#for i in `ls -tr $data/a135feb_04.ldf`   #uncomment to run 1 file 
for i in `ls -tr $data/a135feb_04*.ldf`   #uncomment to run all files with similar name 
